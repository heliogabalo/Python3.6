        ...
        if os.path.exists(input_path):
            ...
            for dir in dirs:
                ...
                if os.path.exists(input_dir_path):
                    ...
                    # Create a soft link in example_etc pointing to the directory in the output directory
                    example_etc_dir_path = os.path.join(example_etc_path, dir)
                    if not os.path.exists(example_etc_dir_path):
                        os.symlink(output_dir_path, example_etc_dir_path)
                        print(f"Created soft link in example_etc: {example_etc_dir_path} -> {output_dir_path}")
                else:
